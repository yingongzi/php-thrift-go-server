...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  GetUserByIdResp GetUserByUserID(GetUserByIdReq req)")
  fmt.Fprintln(os.Stderr, "  SetUsersResp SetUsers(SetUsersReq req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := idl.NewPhp_Go_SvrClientFactory(trans, protocolFactory)
  ...
  case "GetUserByUserID":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "GetUserByUserID requires 1 args")
      flag.Usage()
    }
    arg7 := flag.Arg(1)
    ...
    argvalue0 := idl.NewGetUserByIdReq()
    ...
    value0 := argvalue0
    fmt.Print(client.GetUserByUserID(value0))
    fmt.Print("\n")
    break
  case "SetUsers":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "SetUsers requires 1 args")
      flag.Usage()
    }
    arg13 := flag.Arg(1)
    ...
    value0 := argvalue0
    fmt.Print(client.SetUsers(value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
